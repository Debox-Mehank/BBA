      ...
      >
        ...
        >
            ...
            <div className='flex items-start flex-col' >
                ...
                <button className='bg-bg1 text-bg3 font-nunito md:text-[28px] text-[20px] xsm:px-8 py-2 px-1 font-normal rounded-[20px] uppercase mb-2 xsm:w-[400px] w-[270px]' >Available for iphone</button>
                </Link>
                ...
                <button className='bg-bg1 text-bg3 font-nunito md:text-[28px] text-[20px] xsm:px-8 py-2 px-1 font-normal rounded-[20px] uppercase mb-2 xsm:w-[400px] w-[270px]' >Available for android</button>
                </Link>
