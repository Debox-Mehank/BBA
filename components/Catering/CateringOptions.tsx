...
const CateringOptions: React.FC<ICateringOptions> = ({
  ...
  return (
    <div className="lg:py-20 lg:px-24 xsm:px-12 px-6 py-10 bg-bg1 rounded-[60px] lg:rounded-[100px] z-10 overflow-hidden">
      <p className="xl:text-[90px] xsm:text-[60px]  text-[40px] font-bebas text-bg3 text-center">
        {sectionTitle}
      </p>
      <p className="xl:text-[75px] xsm:text-[45px] text-[30px] font-bebas  text-bg3 text-center -mt-5">
        {sectionSubTitle}
      </p>
