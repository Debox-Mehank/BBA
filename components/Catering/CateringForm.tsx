...
const CateringForm: React.FC = () => {
  ...
  if (isSubmitted) {
    return (
      <div className="px-6 sm:px-12 md:px-16 lg:px-24 py-10 lg:py-20 bg-bg2 rounded-[30px] lg:rounded-[100px] text-center my-10">
        <h2 className="font-bebas text-4xl lg:text-[60px] xl:text-[90px] mb-6 text-bg1">Thank You!</h2>
        <p className="text-xl font-rubik text-bg1 mb-8 max-w-4xl mt-4">
