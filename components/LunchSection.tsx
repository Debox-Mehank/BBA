...
const LunchSection = () => {
  ...
  return (
    ...
    >
      <h1 className='font-bebas mt-[60px] text-[50px] sm:text-[60px] md:text-[80px] leading-[180px] lg:text-[120px] xl:text-[200px] text-bg1 mb-10 w-full text-center'>LUNCH AT BAWARCHI</h1>
      <motion.div
        style={{ y: yTransform }}
        transition={{ duration: 1, ease: "easeInOut" }} // Adjust duration and easing as needed
      >
        <Image src={Thali} alt='thali' className='w-[450px] h-[350px] xsm:w-[500px] xsm:h-[400px] lg:w-[676px] lg:h-[570px]' />
      </motion.div>
      <p className='text-rubik text-xl md:text-2xl max-w-[1242px] text-bg1 text-center mb-10 md:mb-5 leading-8'>
