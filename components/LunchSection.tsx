...
const LunchSection = () => {
  ...
  return (
    ...
    >
      <h1 className='font-bebas mt-[60px] text-[50px] sm:text-[60px] md:text-[80px] leading-[180px] lg:text-[120px] xl:text-[200px] text-bg1 mb-20 w-full text-center'>LUNCH AT BAWARCHI</h1>
      <motion.div
        style={{ y: yTransform }}
