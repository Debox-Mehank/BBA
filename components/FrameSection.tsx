...
const FrameSection = () => {
    ...
    return (
        <div 
            className="py-10 px-6 sm:py-20 sm:px-6 md:px-24 bg-bg1 md:min-h-[120vh] rounded-[60px] md:rounded-[100px] -mt-20 flex items-center justify-evenly z-10 relative h-full lg:h-screen lg:flex-row flex-col overflow-hidden"
        >
            <div ref={scrollRef} className='gap-x-10 flex py-10 lg:h-full lg:overflow-hidden'>
                <div className='hidden lg:block relative w-[360px] h-full overflow-hidden'>
                    <motion.div style={{ y: y1 }} className='absolute top-[10%] left-0 space-y-12'>
                        <Image 
                            src={Image1} 
                            placeholder='blur' 
                ...
                <div className='hidden lg:block relative w-[360px] h-full overflow-hidden'>
                    <motion.div style={{ y: y2 }} className='absolute top-[5%] left-0 space-y-12'>
                        <Image 
                            placeholder='blur' 
